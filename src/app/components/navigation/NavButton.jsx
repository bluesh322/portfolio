import { Github, Home, Linkedin, Notebook, Palette, Phone, User } from 'lucide-react';
    ...
    return (
        ...
        >
            <Link
                ...
                name={label}
            >
                <span className='relative w-14 h-14 p-4 animate-spin-slow-reverse group-hover/icon:pause group-hover/icon:text-accent'>
                    {getIcon(icon)}
